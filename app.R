...
ui <- fluidPage(
    ...
    sidebarLayout(
        ...
        sidebarPanel(
            ...
            selectInput("file", "Choose station and data", choices = stations, selected = 'DE-Kli_FLUXNET2015.csv'),
    ...
    observe({
        ...
        output$graph3 <- renderPlotly({
            ...
            plot_ly(complete_series_select, x = ~Date) %>%
                ...
                add_lines(y = ~swc_p50, name='SWC (50p)', line = list(color = 'rgba(0,0,0,1', dash ="dot")) %>%
